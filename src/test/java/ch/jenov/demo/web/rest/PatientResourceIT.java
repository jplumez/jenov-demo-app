...
import ch.jenov.demo.domain.Patient;
import ch.jenov.demo.repository.PatientRepository;
...
public class PatientResourceIT {
    ...
    public void createPatient() throws Exception {
        ...
        assertThat(testPatient.getNpaLocalite()).isEqualTo(DEFAULT_NPA_LOCALITE);
    ...
    public void updatePatient() throws Exception {
        ...
        assertThat(testPatient.getNpaLocalite()).isEqualTo(UPDATED_NPA_LOCALITE);
